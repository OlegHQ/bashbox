...
use crate::interpreter::expansion::{
    apply_pattern_removal, apply_pattern_replacement_to_slice, format_element_list, slice_elements,
    PatternRemovalSide,
};
...
pub fn apply_positional_slicing(
    ...
    PositionalExpansionResult::new(format_element_list(
        sliced_params,
        is_star,
        prefix,
        suffix,
...
pub fn apply_positional_pattern_replacement(
    ...
    PositionalExpansionResult::new(format_element_list(
        replaced, is_star, prefix, suffix, &state.env,
    ))
}
...
pub fn apply_positional_pattern_removal(
    ...
    let stripped: Vec<String> = params
        ...
        .collect();
    PositionalExpansionResult::new(format_element_list(
        stripped, is_star, prefix, suffix, &state.env,
    ))
}
...
pub fn apply_simple_positional_expansion(
    ...
    let params = get_positional_params(state);
    PositionalExpansionResult::new(format_element_list(
        params, is_star, prefix, suffix, &state.env,
    ))
}
