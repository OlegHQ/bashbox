...
use crate::interpreter::helpers::{
    get_ifs, split_by_ifs_for_expansion_ex, IfsExpansionSplitResult,
};
...
pub fn smart_word_split(segments: &[WordSplitSegment], ifs_chars: &str) -> SmartWordSplitResult {
