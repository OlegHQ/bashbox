...
/// Compile a `regex_lite` expression and test `haystack`; false if the expression is invalid.
pub(crate) fn regex_lite_is_match(regex_expr: &str, haystack: &str) -> bool {
    regex_lite::Regex::new(regex_expr)
